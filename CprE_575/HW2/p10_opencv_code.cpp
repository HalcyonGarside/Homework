...
//	Mat initPic = imread("C:/Users/hoodi/Desktop/Homework/Semester8/HCI575/HW2/HW2/HW2/hw2_files/p10_search.png", IMREAD_GRAYSCALE);
//	Mat picBin, bi;
...
//
//			//Add extra points coinciding with the row's pattern
//			int interval = positions.at(1).y - positions.at(0).y;
//			int yPos = positions.at(0).x;
//			int endPos = positions.at(1).y + interval;
//			while (endPos < testIm.cols)
//			{
//				positions.push_back(Point(yPos, endPos));
//				endPos += interval;
//			}
//
//			//Sort again 'cause I'm paranoid
//			std::sort(positions.begin(), positions.end(), compareColPos);
//
...
//	waitKey(0);
//
//	imwrite("C:/Users/hoodi/Desktop/Homework/Semester8/HCI575/HW2/HW2/HW2/hw2_files/p10_fancy.png", resImCol);
//}