...
//	{
//		numFilled = 0;
//		for (int coord = 0; coord < outMat.cols; coord++)
//		{
//			if (outMat.at<uchar>(i, coord) > 0)
//			{
//				numFilled += 1;
//			}
//		}
//
//		if (numFilled == outMat.cols)
//		{
//			for (int coord = 0; coord < outMat.cols; coord++)
//			{
//				outMat.at<uchar>(i, coord) = 0;
//			}
//		}
//	}
//
...
//	{
//		numFilled = 0;
//		for (int coord = 0; coord < outMat.rows; coord++)
//		{
//			if (outMat.at<uchar>(coord, i) > 0)
//			{
//				numFilled += 1;
//			}
//		}
//
//		if (numFilled == outMat.rows)
//		{
//			for (int coord = 0; coord < outMat.rows; coord++)
//			{
//				outMat.at<uchar>(coord, i) = 0;
//			}
//		}
//	}
//
...
//	Mat initPic = imread("C:/Users/hoodi/Desktop/Homework/Semester8/HCI575/HW2/HW2/HW2/hw2_files/p6_search.png", IMREAD_GRAYSCALE);
//	Mat picBin, bi;
...
//	Mat invX, invO, invD, invB, invH, invP, invS, invV;
...
//	separateSymbolLocs(justShape, xs, invX, invX);
//	separateSymbolLocs(justShape, os, invO, invO);
//	separateSymbolLocs(justShape, ds, invD, invD);
//	separateSymbolLocs(justShape, bs, invB, invB);
//	separateSymbolLocs(justShape, ps, invP, invP);
//	separateSymbolLocs(justShape, hs, invH, invH);
//	separateSymbolLocs(justShape, ss, invS, invS);
//	separateSymbolLocs(justShape, vs, invV, invV);
//
//	Mat unInv, finIm;
...
//	placeInColor(finIm, xs, Vec3i(0, 0, 255));
//	placeInColor(finIm, os, Vec3i(0, 255, 0));
//	placeInColor(finIm, ds, Vec3i(255, 0, 0));
//	placeInColor(finIm, bs, Vec3i(255, 0, 255));
//	placeInColor(finIm, hs, Vec3i(255, 255, 0));
//	placeInColor(finIm, ps, Vec3i(0, 50, 255));
//	placeInColor(finIm, ss, Vec3i(50, 0, 255));
//	placeInColor(finIm, vs, Vec3i(255, 0, 50));
//
//	imshow("ERODED", finIm);
//	waitKey(0);
//
//	imwrite("C:/Users/hoodi/Desktop/Homework/Semester8/HCI575/HW2/HW2/HW2/hw2_files/p6_search_colored.png", finIm);
//}