...
//#define LOW_BOUND -10
//
//bool fft(int n, std::complex<float>* in_vec, std::complex<float>*& out_vec)
//{
...
//	}
//
//	if (!fft(n_dev_2, xe, y0) || !fft(n_dev_2, xo, y1))
//	{
//		delete[] xe;
//		delete[] xo;
//		return false;
...
//	for (int i = 0; i < n_dev_2; i++)
//	{
//		out_vec[i] = y0[i] + omega_y1[i];
//		out_vec[i + n_dev_2] = y0[i] - omega_y1[i];
//	}
//
//	delete[] y0;
//	delete[] omega_y1;
